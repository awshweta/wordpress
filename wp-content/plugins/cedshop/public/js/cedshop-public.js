		...
		$("#checkout").click(function(event) {
			...
			if(name != "") {
				...
				if(!name.match(nameRegex)) {
					$('.nameErr').html("Only alphabetic Character with single space are allowed").css("color","red");
					$('html, body').animate({
			...
			if(city != "") {
				...
				if(!city.match(cityRegex)) {
					$('.cityErr').html("Only alphabetic Character with single space are allowed").css("color","red");
					boolVar = true;
					$('html, body').animate({
